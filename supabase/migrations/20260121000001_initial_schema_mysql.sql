-- =============================================
-- Music Playlist App - Initial Database Schema (MySQL)
-- Migration: 20260121000001_initial_schema_mysql
-- MySQL 8.0+
-- =============================================
...
-- Get user's playlists with security check
CREATE PROCEDURE GetUserPlaylists(IN p_user_id CHAR(36))
BEGIN
...
-- Add song to playlist with security check
